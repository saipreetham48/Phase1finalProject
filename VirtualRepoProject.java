...
public class VirtualRepoProject {
	 static String MY_Dir;
	    File myFolder;

	    public VirtualRepoProject () 
	    {
	    	MY_Dir = System.getProperty("user.dir");
	    	myFolder = new File("C:\\Users\\SAI\\OneDrive\\Desktop\\My repository");
	        if (!myFolder.exists())
	        	myFolder.mkdirs();
	   ...
	   private static final String choice = "\nMAIN MENU - Select any one of the following operations: \n"+"1 - List the files in directory\n"+"2 - Perform functions like Add, Delete or Search\n"+ "3 - Exit";
	    ...
	    void secondView() {
	        ...
	        try(Scanner scanner = new Scanner(System.in))
	        {
	            ...
	            switch (logic){
	                ...
	                case '3' : {
	                    System.out.print("Enter a File Name you want to Search For : ");
	                    String filename = scanner.next().trim();
	    ...
	    public static void main(String[] args) {
	        ...
	        VirtualRepoProject obj = new VirtualRepoProject();
	        obj.firstView();
	    }
}
